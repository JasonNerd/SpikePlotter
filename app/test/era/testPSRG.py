...
from spikePy.event_relate_analysis import *
...
if __name__ == '__main__':
    ...
    bias_start = 0.5
    bias_stop = 1.5
    print(peri_stimulus_raster_gram(spike_train, event_train, bias_start,
                                    bias_stop, bin_size, t_stop=t_stop))
    print(peri_stimulus_time_histogram(spike_train, event_train, bias_start,
                                       bias_stop, bin_size, t_stop=t_stop))
